                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a type="button"
                                                href="<?=BASE_URL('public/admin/GroupsCayThue.php?id=');?><?=$row['id'];?>"
                                                class="btn btn-info"><i class="fas fa-file-medical"></i>
                                                <span>XEM NHÓM</span></a>

                                            <a class="btn btn-primary" href="<?=BASE_URL('public/admin/EditCategoryCayThue.php?id=');?><?=$row['id'];?>"><i
                                                    class="fas fa-edit"></i>
                                                <span>EDIT</span></a>
...
$(".delete").on("click", function() {
    cuteAlert({
        ...
        if (e) {
            $.ajax({
                url: "<?=BASE_URL("assets/ajaxs/admin/delete-category-caythue.php");?>",
                method: "POST",
                dataType: "JSON",
                data: {
                    id: $(this).data('id')
