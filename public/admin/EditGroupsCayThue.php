<?php
    ...
    $title = 'CHỈNH SỬA NHÓM CÀY THUÊ | '.$CMSNT->site('tenweb');
...
{
    $row = $CMSNT->get_row(" SELECT * FROM `groups_caythue` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
...
if(isset($_POST['Save']) && $getUser['level'] == 'admin' )
{
    ...
    $CMSNT->update("groups_caythue", array(
            ...
            <div class="col-md-6">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title">EDIT NHÓM</h3>
